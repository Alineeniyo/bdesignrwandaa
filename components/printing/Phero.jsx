       ...
       <div className="grid grid-cols-2 gap-12 mb-28 container mx-auto mt-8">
           <div className="container my-auto text-center">
              ...
              <div className="flex gap-4">
                 <button className=" text-white w-60  font-medium bg-rose-400 rounded mt-4 hover:bg-white hover:text-black ease-in-out delay-100 duration-500 hover:border-2 hover:text-black hover:border-rose-400 hover:bg-transparent">Make an appointment</button>
           ...
           <div className="w-full h-full">
             <img src="images/Islide.png" alt="" className='object-fit h-full w-full my-auto rounded-lg '/>
           </div>
       </div>
    </>
  )
