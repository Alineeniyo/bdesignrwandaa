    ...
    <div className='grid grid-cols-2 gap-8 mx-36  mt-14 border-white border-2 rounded-lg p-5'>
        <div className="grid grid-cols-2  gap-4">
            <div className="grid grid-rows-2 gap-4">
                <img src="images/image4.jpg" alt="image" className='h-full object-cover rounded-lg '/>
                <img src="images/image4.jpg" alt="image" className='h-full object-cover rounded-lg'/>
            </div>
            <div className="">
                <img src="images/image4.jpg" alt="image" className='h-full object-cover rounded-lg'/>
        ...
        <div className="container my-auto">
            ...
            <button className=" text-white w-80 px-12 py-4 font-medium bg-rose-400 rounded mt-4 hover:bg-white hover:text-black ease-in-out delay-100 duration-500 hover:border-2 hover:text-black hover:border-rose-400 hover:bg-transparent">View more collection</button>            
        </div>
    </div>
  )
}
